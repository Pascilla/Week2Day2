...
driver.findElement(By.xpath("(//div[@class='_5dbb'])[1]/input")).sendKeys("pascilla");
driver.findElement(By.xpath("(//div[@class='_5dbb'])[2]//input")).sendKeys("klinta");
driver.findElement(By.xpath("(//div[@class='_5dbb'])[3]//input")).sendKeys("9009589614");
